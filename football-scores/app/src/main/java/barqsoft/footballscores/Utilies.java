...
public class Utilies {
    ...
    public static String getLeague(Resources res, int leagueNum) {
        switch (leagueNum) {
    ...
    public static String getMatchDay(Resources res, int matchDay,int leagueNum)
    {
    ...
    public static String getScores(Resources res, int homeGoals,int awayGoals) {
        if (homeGoals < 0 || awayGoals < 0) {
            return res.getString(R.string.scores_separator);
        } else {
            return String.valueOf(homeGoals) +
                    res.getString(R.string.scores_separator) +
